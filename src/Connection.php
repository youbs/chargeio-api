...
use Youbs\ChargeIO\Exception\ApiException;
use Youbs\ChargeIO\Exception\AuthenticationException;
use Youbs\ChargeIO\Exception\InvalidRequestException;
...
class Connection
{
    ...
    protected function handleError($statusCode, $json)
    {
        switch ($statusCode) {
            ...
            case '404':
            case '422':
                throw new InvalidRequestException(null, $json);
                break;
            case '401':
        ...
        throw new ApiException(null, $json);
    }
}
